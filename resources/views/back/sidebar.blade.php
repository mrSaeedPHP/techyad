        ...
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                <div class="profile-image">
                    <img class="img-xs rounded-circle" src="{{url('/back/assets/images/faces/admin-pic.jpg')}}"
                         alt="profile image">
                    <div class="dot-indicator bg-success"></div>
                </div>
                <div class="text-wrapper">
                    <p class="profile-name">سیدسعید طهرانچی</p>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/pages/samples/login.html')}}"> سوالات متداول </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/pages/samples/register.html')}}"> خدمات ما </a>
                    </li>
                </ul>
            </div>
        </li>
